...
class WorkingDaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create working_day" do
    assert_difference('WorkingDay.count') do
      post working_days_url, params: { working_day: { day: @working_day.day, description: @working_day.description, time: @working_day.time } }
    end
  ...
  test "should update working_day" do
    patch working_day_url(@working_day), params: { working_day: { day: @working_day.day, description: @working_day.description, time: @working_day.time } }
