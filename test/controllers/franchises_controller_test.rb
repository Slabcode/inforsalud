...
class FranchisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create franchise" do
    assert_difference('Franchise.count') do
      post franchises_url, params: { franchise: { address: @franchise.address, description: @franchise.description, name: @franchise.name } }
    end
  ...
  test "should update franchise" do
    patch franchise_url(@franchise), params: { franchise: { address: @franchise.address, description: @franchise.description, name: @franchise.name } }
