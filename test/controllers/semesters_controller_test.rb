...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { carrer_id: @semester.carrer_id, description: @semester.description, name: @semester.name } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { carrer_id: @semester.carrer_id, description: @semester.description, name: @semester.name } }
